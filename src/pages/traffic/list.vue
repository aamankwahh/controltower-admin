<template>
  <div class="main-page">
    <template v-if="showHeader">
      <q-card
        :flat="isSubPage"
        class="page-section q-py-sm q-px-md q-mb-md nice-shadow-18"
      >
            ...
            <div class="col-12 col-md-auto">
              <div class="">
                <div class="row items-center q-col-gutter-sm q-px-sm">
                  <div class="col">
                    <div class="text-h6 text-primary">Request Logs</div>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="col">
                      ...
                      <div>
                        <q-table
                          ...
                          :bordered="false"
                          :columns="$menus.RequestLogTableHeaderItems"
                          :rows="records"
                          binary-state-sort
                        ...
                        >
                          ...
                          <template v-slot:body="props">
                            ...
                            >
                              ...
                              <q-td key="request_type" :props="props">
                                {{ props.row.request_type }}
                              </q-td>
                              <q-td key="requested_action" :props="props">
                                {{ props.row.requested_action }}
                              </q-td>
                        ...
                        <div class="">
                          <div class="q-pa-sm" v-show="pageReady">
                            <div class="row justify-between">
                              ...
                              <div
                                v-if="paginate && totalRecords > 0"
                                class="row q-col-gutter-md justify-center"
                              >
                                <div class="col-auto">
                                  <q-chip
                                    >Records {{ recordsPosition }} of
                                    {{ totalRecords }}</q-chip
                                  >
                                </div>
